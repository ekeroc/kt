...
kernM_makefn="Makefile_test_thread_manager"
...
{
    tmp_kverN_str=${1}
    printf "\n--------> thread_manager build all utest with ${tmp_kverN_str}\n"
    ...
    /bin/mv test_thread_manager.ko "${tmp_dir}/test_thread_manager-${kverN_str}.ko"
}
