...
kernM_makefn="Makefile_test_discoC_mem_mgr"
...
{
    tmp_kverN_str=${1}
    printf "\n--------> discoC_mem_manager build all utest with ${tmp_kverN_str}\n"
    ...
    /bin/mv test_discoC_mem_manager.ko "${tmp_dir}/test_discoC_mem_manager-${kverN_str}.ko"
}
