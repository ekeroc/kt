 ...
 *
 * Test_discoC_mem_manager_module.c
 *
 */
...
{
    return init_test_discoC_mem_mgr();
}

static void __exit exit_test_module (void) {
    rel_test_discoC_mem_mgr();
}
