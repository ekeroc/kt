...
KVER = 4.4.0-130-generic
KTF_DIR = /home/louis/src/ktf/kernel
KTF_BDIR = /home/louis/build/4.4.0-130-generic/ktf/kernel
_DISCO_CN_ROOT := ../
...
# hello-objs += ../drv_fsm.o ../drv_chrdev.o ../drv_blkdev.o
# hello-objs +=
...
hello-objs += ktfff_unittest/unittests/hello.o
obj-m := hello.o
hello-objs := $(addprefix $(_DISCO_CN_ROOT), $(hello-objs))
...
module:
	$(MAKE) -C $(KDIR) SUBDIRS=$(PWD) $(EXTRASYMS) M=$(PWD) modules
clean:
